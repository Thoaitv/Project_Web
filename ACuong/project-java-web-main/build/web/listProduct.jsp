<%-- 
    ...
    Created on : Dec 16, 2020, 10:25:05 PM
    Author     : ADMIN
--%>
                                                    ...
                                                    <tbody
                                                        <c:forEach items="${requestScope.listProduct}" var="p" varStatus="loop">
                                                            <tr>
                                                                ...
                                                                <td style="vertical-align: middle; padding-left: 30px;"><img style="width: 90%; padding-bottom: -100px;" src="images/home/${p.image}" alt=""/></td>
