<%-- 
    Document   : homeAdmin
    Created on : Dec 15, 2020, 2:35:00 PM
    Author     : ADMIN
--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <a class="metric-link" href="listProduct" style="color: #676A6D;">
                                            <div class="metric" style="box-shadow: 0 0 3px;">
                                                <span class="icon"><i class="fab fa-product-hunt" style="font-size: 26px; margin-top: 12px;"></i></span>
                                                <p>
                                    ...
                                    <div class="col-md-3">
                                        <a class="metric-link" href="listUser" style="color: #676A6D;">
                                            <div class="metric" style="box-shadow: 0 0 3px;">
                                                <span class="icon"><i style='font-size:24px; margin-top: 2px;' class='fas'>&#xf0c0;</i></span>
                                                <p>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:if test="${o.status eq 'waiting_line'}">
                                                                    <a href="updateStatusOrder?orderId=${o.orderId}&page=home"><span class="label label-warning">ACCEPT</span></a>
                                                                </c:if>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
