<%-- 
    Document   : header
    Created on : Jun 19, 2021, 5:00:05 AM
    Author     : thoai
--%>
                        ...
                        <div class="our-link">
                            <ul>
                                <c:if test="${sessionScope.user != null}">
                                    <li><span style="color: #575758;">Welcome ${sessionScope.user.userName}</span></li>
                                    </c:if>
                                <li><a href="HomeAdminServlet">Admin</a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="HomeServlet"><img src="images/logo.png" class="logo" alt=""></a>
                    </div>
                        ...
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <c:if test="${sessionScope.user == null}">
                                        <a href="login.jsp" class="auth-form-subtitle">Cart</a>
                                    </c:if>
                            </li>
                            ...
                            <li>
                                <c:if test="${sessionScope.user!=null}">
                                    <a class="cart" href="OrderServlet?productId=${p.productId}">Order</a>
                                </c:if>
                                <c:if test="${sessionScope.user == null}">
                                    <a href="login.jsp" class="auth-form-subtitle">Order</a>
                                </c:if>
                            </li>
                    ...
                    <div class="attr-nav">
                        <ul>
                            ...
                            <c:if test="${sessionScope.user!=null}">
                                <li class="side-menu"><a href="CartServlet">
                                        <i class="fa fa-shopping-bag"></i>
                                        <span class="badge">3</span>
                                    </a></li>
                                </c:if>
                                <c:if test="${sessionScope.user == null}">
                                <li class="side-menu"><a href="login.jsp">
                                        <i class="fa fa-shopping-bag"></i>
                                        <span class="badge">3</span>
                                    </a></li>
                                </c:if>
