<%-- 
    ...
    Created on : Jun 19, 2021, 2:24:10 AM
    Author     : thoai
--%>
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        <div class="box-img-hover">
                                                            ...
                                                            <img src="images/products/${pc.image}" class="img-fluid" alt="Image">
                                                            <div class="mask-icon">
                                                                <ul>
                                                                    <li><a href="ProductDetailsServlet?productId=${pc.productId}" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
